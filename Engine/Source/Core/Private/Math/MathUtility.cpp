...
namespace Berserk
{
    ...
    {
        assertion_dev_msg(up >= down, "Upper limit should be more than lower limit");
    ...
    {
        assertion_dev_msg(p2 > p1, "Upper limit should be more than lower limit");
        assertion_dev_msg((t >= p1 && t <= p2), "Param t should be in [p1; p2]");
    ...
    {
        assertion_dev_msg(min < max, "Upper limit should be more than lower limit");
