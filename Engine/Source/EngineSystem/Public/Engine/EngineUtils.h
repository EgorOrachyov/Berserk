...
namespace Berserk
{
    ...
    public:
        ...
        {
            auto data = allocator.engine_new_const<ResourceHandleData>((TSharedPtr<Resource>) res);
        ...
        {
            auto data = allocator.engine_new_const<ObjectHandleData>((TSharedPtr<Object>) res);
