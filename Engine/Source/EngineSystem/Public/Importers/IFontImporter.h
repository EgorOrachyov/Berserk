...
namespace Berserk
{
    ...
    public:
        ...
        /**
         * Import single font data of specified size from TTF file
         ...
         */
        virtual TSharedPtr<FontImportData> load(const char *filename, const char *fontname, uint32 fontSize) = 0;
