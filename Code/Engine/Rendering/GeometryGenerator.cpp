...
namespace Berserk {
    ...
    void GeometryGenerator::generateSphere(float radius, int32 stepsH, int32 stepsV, const VertexPolicy &policy, uint32 &vertsCount, TArray <uint8> &verts, TArray <uint32> &indices) {
        Vec3f pos;
        Vec3f norm;
        Vec2f texcoords;
