...
namespace Berserk {
    ...
    public:
         ...
         */
        VertexPolicy(const TArrayStatic<EVertex> &elements);
        VertexPolicy();
        ...
        const TArrayStatic<uint32> getElementsOffsets() const { return  mElementsOffsets; }
        const TArrayStatic<uint32> getElementsLocations() const { return mElementsLocations; }

    protected:
        uint32 mStride = 0;
        VertexInput mVertexInput;
        TArrayStatic<EVertex> mElementsList;
        TArrayStatic<uint32> mElementsOffsets;
        TArrayStatic<uint32> mElementsLocations;
    };
